                    ...
                    match e.name().as_ref() {
                        ...
                        b"prgad:miejscowosc" => {
                            ...
                            match city {
                                ...
                                Some(c) => {
                                    self.builders.city.append_value(&c.name);
                                    self.builders
                                        .municipality_teryt_id
                                    ...
                                    match terc_info {
                                        ...
                                        Some(t) => {
                                            ...
                                            self.builders
                                                .county
                                                .append_value(t.county_name.clone());
                                            self.builders
                                                .municipality
                        ...
                        b"prgad:ulica2" => {
                            ...
                            match street {
                                ...
                                Some(s) => {
                                    self.builders.street.append_value(&s.name);
                                    option_append_value_or_null(
